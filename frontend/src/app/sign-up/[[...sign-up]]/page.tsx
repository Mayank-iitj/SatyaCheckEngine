  ...
  const roles = [
    {
      ...
      description: "Protect yourself from financial scams, deepfakes, and vishing calls.",
      icon: User,
    ...
    },
    {
      ...
      description: "Full access to all 4 AI engines and Cognita intelligence assistant.",
      icon: Shield,
        ...
        <div className="z-10 w-full max-w-md flex flex-col items-center">
          ...
          <div className="w-full bg-bronze/10 border border-bronze/20 rounded-xl p-4 mb-6 text-center">
            ...
            <p className="text-sm text-ink-300">
              Create account as <strong className="text-parchment-100 font-mono bg-ink-800 px-2 py-1 rounded ml-1">{roleConfig?.demoEmail}</strong>
            </p>
          </div>
          <SignUp fallbackRedirectUrl={`/${roleConfig?.redirect || "verify"}`} />
        </div>
      </div>
    );
  }
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-ink-900 p-6 relative">
      ...
      <div className="z-10 w-full max-w-2xl">
        <div className="text-center mb-12">
          ...
          <p className="text-ink-400 font-medium text-sm tracking-widest uppercase">Create your account</p>
        </div>
        ...
        <p className="text-center text-xs text-ink-500 mt-8">
          Already have an account? <Link href="/sign-in" className="text-bronze hover:underline">Sign In</Link>
